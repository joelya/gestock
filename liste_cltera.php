...
//liste des dci
	...
	$sql_cltera = "SELECT * FROM `classe_therap` WHERE flag=1 ORDER BY cltera_lib ASC";
	$list = $pdo->prepare($sql_cltera);
    $list->execute();
...
if(con==true){
location.href='page.php?p=up_cltera&cltera_ids='+isbn;
//location.replace('?pages=paramettre&tp='+isbn);
}
else{
location.href='page.php?p=liste_cltera';
return false;
}
}
</script>
      ...
      <!-- BEGIN PAGE BAR -->
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Liste des Classes therapeutiques</a>
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                                               ...
                                                               <a class="btn green" href="<?= $_SESSION['proflis']?>.php?p=add_cltera"><i class="fa fa-plus"></i>Ajouter</a>
...
<?php foreach ($list as $key => $result): ?>
            ...
            <tr>
                ...
                <td>
                   <?= ucfirst(strtolower($result['cltera_lib'])) ?>
                </td>
               <td>
                   <?= $result['cltera_date_crea'] ?>
                </td>
                <td>
                	<?= $result['cltera_date_mod'] ?>
                </td>
               
                                               <td align="left" nowrap="nowrap"><a href="<?= $_SESSION['proflis']?>.php?p=up_cltera&cltera_id=<?php echo $result['cltera_id']; ?>" class="btn btn-outline btn-circle btn-sm blue">
