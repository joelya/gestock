...
//PARAMETRAGE CAISSE
	...
	$sql_caisse = "SELECT caisse.caiss_id,point_vente.pvte_lib,caisse.pvte_id,caisse.caiss_code,caisse.caiss_lib,caisse.caiss_flag_actif FROM `caisse` INNER JOIN point_vente ON caisse.pvte_id = point_vente.pvte_id WHERE `caiss_flag_actif`=1";
	$list = $pdo->prepare($sql_caisse);
    $list->execute();
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                                               ...
                                                               <a class="btn green" href="<?= $_SESSION['proflis']?>.php?p=add_caisse"><i class="fa fa-plus"></i>Ajouter</a>
               ...
               <td>
                ...
                <td>
                	<?= $result['pvte_lib'] ?>
                                               ...
                                               <td align="left" nowrap="nowrap"><a href="<?= $_SESSION['proflis']?>.php?p=up_caisse&caiss_id=<?php echo crypturl($result['caiss_id']); ?>" class="btn btn-outline btn-circle btn-sm blue">
