<?php 
		    ...
		    if($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_POST) && isset($_POST['valid_info']))
     {
		 	...
		 	$prof_lib = htmlentities(trim($_POST['prof_lib']));
	   ...
	   if($valid == true){
			...
			//Insertion 
             ...
             `prof_lib`,`prof_date_crea`, `prof_date_mod`, `flag`)
    VALUES (?, ?, ?, ?);
";	
		$req = $pdo->prepare($sql);
		$req->execute(array($prof_lib,$dateMod,$dateMod,1));
			 /**
		   *	REDIRECTION JAVASCRIPT
		   **/
			echo '<script>location.href="'.$_SESSION['proflis'].'.php?p=liste_grp&insert=ok"</script>';
			
			
					//header('Location:page.php?p=liste_ent&medi_id='.$up);
			}
	 }
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                             ...
                             <li>
                              <a href="<?= $_SESSION['proflis']?>.php?p=liste_grp"><span class="caption"> Liste des groupe d'utilisateurs</span></a>
                               <i class="fa fa-circle"></i>
                            </li>
                            <li>
                              <a href="#"><span class="caption">Ajouter groupe d'utilisateur</span></a>
								...
								<form action="" method="post" class="form-horizontal">
                                        <div class="portlet box blue-hoki">
                                            <div class="portlet-title">
                                             <div class="caption">Ajout de groupe d'utilisateur</div>
                                          </div>
                                                ...
                                                <!-- BEGIN FORM-->
													...
													<div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-7">
                                							  <input type="text" name="prof_lib" id="prof_lib" size="45" maxlength="255" class="form-control" value="<?= !empty($_POST['prof_lib'])?$_POST['prof_lib']:''; ?>" />
