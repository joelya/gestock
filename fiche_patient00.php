...
<?php endif; ?>	
<?php if ($cloturer==0) : ?>												<select name="path_id[]" multiple class="form-control select2-multiple" id="multiple[]"  <?php if ($cloturer==1){ echo 'readonly=readonly'; } ?>>
...
<?php endif; ?>															  <?php if(!empty($errors[0])): ?>
										...
										<div class="portlet light bordered">
											...
											<div>
													...
													<?php endif; ?>
															...
															<br/><input class="btn green" type="submit" name="clot_prescr" value="cloturer" />  
															</form>
															<?php endif; ?>
															<button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; m&eacute;dicaments prescrits</button>
															<?php endif; ?>
															<hr />
