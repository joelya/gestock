...
<tr>
  ...
  <th nowrap="nowrap">Valeur du seuil</th>
...
<?php foreach ($list as $key => $result): ?>
            ...
            <tr>
                <td><?= $result['seuil_val'] ?></td>
                <td align="left" nowrap="nowrap"><a href="<?= $_SESSION['proflis']?>.php?p=up_seuil&seuil_id=<?php echo crypturl($result['seuil_id']); ?>" class="btn btn-outline btn-circle btn-sm blue">
