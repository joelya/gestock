      ...
      <!-- BEGIN PAGE BAR -->
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Liste des Catégories de produit</a>
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                                               ...
                                                               <a class="btn green" href="<?= $_SESSION['proflis']?>.php?p=add_fam"><i class="fa fa-plus"></i>Ajouter</a>
...
<?php foreach ($list as $key => $result): ?>
            ...
            <tr>
                ...
                <td><?= $result['fam_code'] ?></td>
                <td>
                   <?= $result['fam_libel'] ?>
                </td>
               <td align="left" nowrap="nowrap"><a href="<?= $_SESSION['proflis']?>.php?p=up_fam&fam_id=<?php echo crypturl($result['fam_id']); ?>" class="btn btn-outline btn-circle btn-sm blue">
