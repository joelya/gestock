...
<html lang="en">
    ...
    <head>
		...
		<title>APP_DOCTOR ::. Application de gestion de l'infirmerie de la LDF</title>
            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                                ...
                                <li class="nav-item <?php if(isset($_GET['p']) AND ($_GET['p']=='liste_prod' || $_GET['p']=='up_prod' || $_GET['p']=='add_prod')){ echo 'start active open '; }?>">
								  ...
								  <li class="nav-item <?php if(isset($_GET['p']) AND $_GET['p']=='liste_fam' || $_GET['p']=='up_fam' || $_GET['p']=='add_fam'){ echo 'start active open '; }?> ">
                                    <a href="<?= $_SESSION['proflis']?>.php?p=liste_fam" class="nav-link ">
                                        <span class="title">Cathegorie des produits</span>
                                    </a>
                                </li>
					   ...
					   <li class="nav-item <?php if (isset($_GET['p']) AND($_GET['p']=='hist_cons' || $_GET['p']=='hist_pres' || $_GET['p']=='liste_armal')){ echo 'start active open '; }?> ">
                            <a href="javascript:;" class="nav-link nav-toggle">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item <?php if(isset($_GET['p']) AND $_GET['p']=='hist_cons'){ echo 'start active open '; }?> ">
                                    <a href="<?= $_SESSION['proflis']?>.php?p=hist_cons" class="nav-link ">
                                        <span class="title">Hist des ventes par boutiques</span>
                                    </a>
                                </li>
                                <li class="nav-item <?php if(isset($_GET['p']) AND $_GET['p']=='hist_pres'){ echo 'start active open '; }?> ">
                                    <a href="<?= $_SESSION['proflis']?>.php?p=hist_pres" class="nav-link ">
                                        <span class="title">Hist des vente par période</span>
                                    </a>
                                </li>
								
								<li class="nav-item <?php if(isset($_GET['p']) AND $_GET['p']=='liste_armal'){ echo 'start active open '; }?> ">
                                    <a href="<?= $_SESSION['proflis']?>.php?p=liste_armal" class="nav-link ">
                                        <span class="title">Classement des boutiques </span>
                                    </a>
                                </li>
								<li class="nav-item <?php if(isset($_GET['p']) AND $_GET['p']=='liste_armal'){ echo 'start active open '; }?> ">
                                    <a href="<?= $_SESSION['proflis']?>.php?p=liste_armal" class="nav-link ">
...
<!-- BEGIN QUICK SIDEBAR -->
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> &copy; Tous droits réservés. Barnoin Informatique 
            </div>
