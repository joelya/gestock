...
?>
      ...
      <!-- BEGIN PAGE BAR -->
				 ...
				 <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> 
                                  Liste des sous catégories de produit
                    </h3>
                    <!-- END PAGE TITLE-->
                      <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                                               ...
                                                               <a class="btn green" href="<?= $_SESSION['proflis']?>.php?p=add_sfam"><i class="fa fa-plus"></i>Ajouter</a>
...
<?php foreach ($list as $key => $result): ?>
            ...
            <tr>
                ...
                <td><?= $result['sfam_code'] ?></td>
                <td><?= $result['fam_libel'] ?></td>
                <td>
                   <?= $result['sfam_lib'] ?>
                </td>
               <td align="left" nowrap="nowrap"><a href="<?= $_SESSION['proflis']?>.php?p=up_sfam&sfam_id=<?php echo crypturl($result['sfam_id']); ?>" class="btn btn-outline btn-circle btn-sm blue">
