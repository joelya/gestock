...
";	
        ...
        **/
			...
			echo 'Vous ne pouvez pas ajouter un m&eacute;dicament plusieurs fois';
			//echo $e->getMessage();
		}
	}
...
<table cellspacing="0" width="100%" id="example" class="table table-striped table-hover table-responsive">
															...
															$stmt2 = $db_con->prepare("SELECT * FROM `prescrire_medi` INNER JOIN prescription ON prescrire_medi.`presc_id` = prescription.`presc_id` JOIN medicament ON prescrire_medi.`medi_id` = medicament.`medi_id` WHERE prescription.`presta_id` = '".@$_SESSION['codep']."' ORDER BY prescrire_medi.prescr_id DESC");
															$stmt2->execute();
